...
public class DeclarationService {
    ...
    public Declaration update(Long id, Declaration request) {
        ...
        entity.setRdInvestment(request.getRdInvestment());
        entity.setRdRatio(request.getRdRatio());
        entity.setDebtRatio(request.getDebtRatio());
        entity.setPatentCount(request.getPatentCount());
        entity.setMarketShare(request.getMarketShare());
        entity.setProductName(request.getProductName());
        entity.setProductMarketShare(request.getProductMarketShare());
        entity.setChainDescription(request.getChainDescription());

        // 专精特新字段
        entity.setMarketYears(request.getMarketYears());
        entity.setEquityFinancing2y(request.getEquityFinancing2y());
        entity.setNetProfit(request.getNetProfit());
        entity.setMainRevenue(request.getMainRevenue());
        entity.setMainRevenueRatio(request.getMainRevenueRatio());
        entity.setRevenueGrowth2yAvg(request.getRevenueGrowth2yAvg());
        entity.setLeadProductDomain(request.getLeadProductDomain());
        entity.setDigitalLevel(request.getDigitalLevel());
        entity.setNetProfitRate(request.getNetProfitRate());
        entity.setQualityAwardProvincial(request.getQualityAwardProvincial());
        entity.setQualityIso(request.getQualityIso());
        entity.setQualityBrand(request.getQualityBrand());
        entity.setQualityStandard(request.getQualityStandard());
        entity.setFeatureKeyIndustry(request.getFeatureKeyIndustry());
        entity.setFeatureSpecialTech(request.getFeatureSpecialTech());
        entity.setFeatureFirstSet(request.getFeatureFirstSet());
        entity.setFeatureGreenMfg(request.getFeatureGreenMfg());
        entity.setFeatureChuangke(request.getFeatureChuangke());
        entity.setFeatureDesignAward(request.getFeatureDesignAward());
        entity.setTalentNational(request.getTalentNational());
        entity.setTalentProvincial(request.getTalentProvincial());
        entity.setTalentCity(request.getTalentCity());
        entity.setTalentRecommend(request.getTalentRecommend());
        entity.setIpHighValue(request.getIpHighValue());
        entity.setIpClass1Self(request.getIpClass1Self());
        entity.setIpClass1(request.getIpClass1());
        entity.setIpClass2(request.getIpClass2());
        entity.setRdStaffRatio(request.getRdStaffRatio());
        entity.setRdInstitutionLevel(request.getRdInstitutionLevel());
